...
const SalesApartments = () => {
  ...
  const saleApartments = onlyApartments.filter(apartment => apartment.Operation === "sale");
  const apartmentList = saleApartments.map((apartment) => (
