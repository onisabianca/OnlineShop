...
const SalesStudios = () => {
  ...
  const saleStudios = onlyStudios.filter(studio => studio.Operation === "sale");
  const studioList = saleStudios.map((studio) => (
